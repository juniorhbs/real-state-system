        ...
        <div class="row">
            <form action="" class="form-inline w-100">
                <div class="form-group col-3">
                    <label for="search" class="mb-2"><strong>Comprar ou Alugar</strong></label>
...
<section class="main_list_group py-5 bg-light">
    <div class="container">
        <div class="p-4 border-bottom border-front">
            <h1 class="text-center">Ambiente no seu <strong class="text-front">estilo</strong></h1>
            ...
            <article class="col-4">
                <div class="card main_properties_item">
                    ...
                    <div class="card-body">
                        ...
                        <p class="main_properties_item_category">Imóvel Residêncial</p>
...
<section class="main_properties bg-light py-5">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center border-bottom border-front mb-5">
        ...
        <div class="row">
            <article class="col-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="properties/4/b7fcdcb2-0a18-40f4-a60c-0c3184f52815.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="" class="text-front">Linda Casa no Campeche com vista para o Mar</a></h2>
            ...
            <article class="col-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="properties/5/2ed554e7-1640-4220-97fd-c2f056f1bcaa.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="" class="text-front">Linda Casa no Campeche com vista para o Mar</a></h2>
